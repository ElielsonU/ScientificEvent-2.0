    ...
    return (
        ...
        onSubmit={formSubmit}>
            ...
            <Box width={widths.w2} display="flex" flexDirection="row-reverse" justifyContent="space-between">
                <Button fontSize={fonts.f2} fontWeight={weights.bold} color={colors.c2} backgroundColor={colors.c4} padding="9px 17px" borderRadius={radius.r3} borderColor={colors.c4} borderWidth={thickness.t2}>
                    Login
                </Button>

                <Button fontSize={fonts.f2} fontWeight={weights.bold} color={colors.c4} backgroundColor={colors.c2} padding="9px 17px" borderRadius={radius.r3} borderWidth={thickness.t2} onClick={changeForm}>
                    Sign Up
                </Button>
            </Box>
        </Form>
